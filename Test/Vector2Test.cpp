...
using Vector2 = LMath::VectorBase<double, 2>;
...
TEST_CASE("Angle between Vector2s", "[Vector2]")
{
    ...
    Vector2 v1 = Vector2(2, -5);
    Vector2 v2 = Vector2(6, 2);
    CHECK(v1.Angle(v2) == Approx(1.5120404684));
    // Case 2
    v1 = Vector2(0.24, 0.0082);
    v2 = Vector2(0.53, -0.0532);
    CHECK(v1.Angle(v2) == Approx(0.1341958967));
    // Case 3
    v1 = Vector2(-27, 83);
    v2 = Vector2(36, -64);
    CHECK(v1.Angle(v2) == Approx(2.9437072677));
}
...
//    Vector2 v1 = Vector2(2, -5);
//    Vector2 v2 = Vector2(6, 2);
//    CHECK(v1.Component(v2) == Approx(0.316227766));
//    // Case 2
//    v1 = Vector2(0.24, 0.0082);
//    v2 = Vector2(0.53, -0.0532);
//    CHECK(v1.Component(v2) == Approx(0.2379810081));
//    // Case 3
//    v1 = Vector2(-27, 83);
//    v2 = Vector2(36, -64);
//    CHECK(v1.Component(v2) == Approx(-85.5778230514));
//}
...
TEST_CASE("Distance between Vector2 points", "[Vector2]")
{
    ...
    Vector2 v1 = Vector2(2, -5);
    Vector2 v2 = Vector2(6, 2);
    CHECK(v1.Distance(v2) == Approx(8.0622577483));
    // Case 2
    v1 = Vector2(0.24, 0.0082);
    v2 = Vector2(0.53, -0.0532);
    CHECK(v1.Distance(v2) == Approx(0.2964286761));
    // Case 3
    v1 = Vector2(-27, 83);
    v2 = Vector2(36, -64);
    CHECK(v1.Distance(v2) == Approx(159.9312352231));
}
...
TEST_CASE("Dot product of Vector2s", "[Vector2]")
{
    ...
    Vector2 v1 = Vector2(2, -5);
    Vector2 v2 = Vector2(6, 2);
    CHECK(v1.Dot(v2) == Approx(2));
    // Case 2
    v1 = Vector2(0.24, 0.0082);
    v2 = Vector2(0.53, -0.0532);
    CHECK(v1.Dot(v2) == Approx(0.12676376));
    // Case 3
    v1 = Vector2(-27, 83);
    v2 = Vector2(36, -64);
    CHECK(v1.Dot(v2)== Approx(-6284));
}
...
//TEST_CASE("Lerp two Vector2s clamped", "[Vector2]")
//{
//    // Case 1
//    Vector2 v1 = Vector2(2, -5);
//    Vector2 v2 = Vector2(6, 2);
//    Vector2 v = v1.Lerp(v2, -0.2);
//    CHECK(v.X() == Approx(2));
//    CHECK(v.Y() == Approx(-5));
//    // Case 2
//    v1 = Vector2(0.24, 0.0082);
...
TEST_CASE("Magnitude of a Vector2", "[Vector2]")
{
    // Case 1
    Vector2 v = Vector2(2, -5);
    CHECK(v.Length()== Approx(5.385164807));
    // Case 2
    v = Vector2(0.24, 0.0082);
    CHECK(v.Length() == Approx(0.2401400425));
    // Case 3
    v = Vector2(-27, 83);
    CHECK(v.Length() == Approx(87.2811549));
}
